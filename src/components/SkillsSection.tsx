...
const skillCategories: SkillCategory[] = [
	{
		...
		title: "Frontend",
		skills: ["Flutter", "React Native", "UIKit/SwiftUI", "Jetpack Compose", "ReactJS", "NextJS", "Tauri"],
	},
	{
		icon: <Storage sx={{ fontSize: 28 }} />,
		title: "Backend / Database",
		skills: ["ExpressJS", "ElysiaJS", "FastAPI", "MySQL", "PostgreSQL", "SQLite", "MongoDB", "Firebase"],
	},
	{
		icon: <Terminal sx={{ fontSize: 28 }} />,
		title: "Languages",
		skills: ["JavaScript/TypeScript", "Python", "Dart", "Swift", "Kotlin", "C/C++", "C#", "Java"],
	},
	{
		icon: <AccountTree sx={{ fontSize: 28 }} />,
		title: "Software / Architecture",
		skills: ["Git", "GitHub", "Docker", "Linux", "VPS", "Data Structure", "OOP", "SDLC", "MVVM", "Clean Code", "BLoC", "SOLID"],
	},
	{
		icon: <Psychology sx={{ fontSize: 28 }} />,
		title: "AI Development",
		skills: ["Deep Learning", "LLM", "TensorFlow", "PyTorch", "OpenCV", "CoreML", "MLKit"],
	},
	{
		icon: <SmartToy sx={{ fontSize: 28 }} />,
		title: "AI Tools / Agents",
		skills: ["Claude", "OpenAI Codex", "Copilot", "Gemini", "Ollama", "Opencode", "MCP Tools", "AI Skills", "OpenClaw", "n8n"],
	},
	{
